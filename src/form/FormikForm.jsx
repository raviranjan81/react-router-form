...
function FormikForm() {
  ...
  return <div className="page">
    ...
    <div className=" flex w-[50%] flex-col gap-1">
        ...
        {errors.name && touched.name ?(<h3 className="text-red-500">{errors.name}</h3>):null}
        <label htmlFor="">Email</label>
        <input type="email" name="email" id="" onBlur={handleBlur}   onChange={handleChange}/>
        {errors.email && touched.email ?(<h3 className="text-red-500">{errors.email}</h3>):null}
